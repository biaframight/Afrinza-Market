...
const slides = [
  ...
  },
  {
    ...
    subtitle: "African riders delivering wherever you are — join as a rider or book a delivery today.",
  ...
  },
  {
    ...
    subtitle: "One platform for every African in the diaspora, wherever you call home.",
